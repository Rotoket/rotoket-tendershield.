    ...
    return (
        <div className="bg-gray-800/50 rounded-lg p-4 mb-4 border border-gray-700">
            <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-semibold text-white">Подготовка аналитического обзора...</h3>
            </div>
            ...
            {displayedSteps.length > 0 && (
                <div className="mt-4 space-y-2">
                    <p className="text-xs text-gray-500 uppercase tracking-wide">Выполненные шаги анализа:</p>
